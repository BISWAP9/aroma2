			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							<h4>Новенький на нашем сайте?</h4>
							<p>Для получения доступа к акциям и скидкам нужно зарегистрироваться</p>
							<a class="button button-account" href="/auth">Создать новый аккаунт</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        И будете перенаправлены на страницу личного кабинета.
      </div>
    </div>
  </div>
</div>
